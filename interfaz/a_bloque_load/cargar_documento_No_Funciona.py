...
def detectar_estructura_capitulos_pdf(ruta_pdf, max_paginas=5):
    ...
    if frecuencias[patron_detectado] == 0:
            ...
            # Mensaje de aviso
            '''mensaje = tk.Label(
                ventana_opciones,text=traducciones["Estructura_de_capítulos_no_reconocida"],
                wraplength=350,
                justify="center",
            )
            ...
            boton_forzar = tk.Button(
                frame_botones,
                text="Forzar",
                command=lambda: decision.set("forzar"),
            )
            ...
            boton_cancelar = tk.Button(
                frame_botones,
                text="Cancelar",
                command=lambda: decision.set("cancelar"),
            )
            ...
            boton_modificar = tk.Button(
                frame_botones,
                text="Modificar PDF",
                command=lambda: decision.set("modificar"),
            )
            ...
            return None
            # Tomar acción según la decisión del usuario
            #if decision.get() == "forzar":
            #    print("Forzar seleccionado")
                #capitulos = [texto_pdf]  # Procesar todo como un único capítulo
            #elif decision.get() == "cancelar":
            #    print("Operación cancelada por el usuario")
            #    return  # Salir de la función
            #elif decision.get() == "modificar":
            #    print("Modificar PDF seleccionado")
                # Aquí puedes añadir la lógica para mostrar las instrucciones
            #    return  # Salir de la función tras mostrar instrucciones
...
def cargar_documento_completo(traducciones, entry_archivo, proyecto_id, frame_visual):
    ...
    try:
        ...
        ##### ESTO HAY QUE MODIFICAR PARA QUE EL BOTON DE TRES OPCIONES NO DA NINGUNA SOLO SALE LA ALERTA  TAL Y COMO ESTA
