...
def asignar_subsistemas_a_documento_y_mostrar_ventana(traducciones,texto_documento, documento_id, frame_visual):
    ...
    tk.Label(ventana_subsistemas, text=traducciones["M_Subsistemas_sugeridos_para_el_documento"]).pack(pady=10)
    ...
    boton_aceptar = tk.Button(ventana_subsistemas, text=traducciones["B_ACEPTAR"], 
