...
from .seleccionar_archivo import seleccionar_archivo, ventana_seleccionar_proyecto, aceptar_proyecto
from .cargar_documento import cargar_documento, guardar_requisitos_y_asociaciones
from .asignar_subsistemas import asignar_subsistemas_a_documento_y_mostrar_ventana,aceptar_asignacion_subsistemas
...
def crear_bloque_load(frame_funcionalidades, traducciones, frame_visual):
    ...
    frame_load = tk.Frame(frame_funcionalidades, bg="#125ca6", highlightbackground="#3790e9", highlightthickness=3, padx=5, pady=3)
