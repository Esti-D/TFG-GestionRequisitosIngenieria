...
def crear_boton_proyecto(traducciones,frame_funcionalidades, frame_visual):
    ...
    def agregar_proyecto():
        ...
        if proyecto:
            ...
            tk.messagebox.showerror(traducciones["M_Error"], traducciones["M_Ingrese_un_nombre_de_proyecto"])
    ...
    def mostrar_proyectos():
        ...
        for proyecto in proyectos:
            lista_proyectos.insert(tk.END, f"ID: {proyecto[0]} - {traducciones["T_Nombre_proyecto"]}: {proyecto[1]}")  # Mostrar ciudades
    ...
    def eliminar_proyecto():
        ...
        if proyecto_id:
            ...
            tk.messagebox.showerror(traducciones["M_Error"], traducciones["M_Ingrese_un_ID_valido"])
    ...
    label_proyecto = tk.Label(frame_visual, text=traducciones["A_NUEVO_Proyecto"], font=("Arial", 12))
    ...
    boton_agregar = tk.Button(frame_visual, text=traducciones["A_Agregar_Proyecto"], command=agregar_proyecto)
    ...
    label_id_eliminar = tk.Label(frame_visual, text=traducciones["A_ID_de_Proyecto_a_Eliminar"], font=("Arial", 12))
    ...
    boton_eliminar = tk.Button(frame_visual, text=traducciones["A_Eliminar_Proyecto"], command=eliminar_proyecto)
