...
def actualizar_combobox(tipo_consulta, combobox_subsistemas, combobox_proyectos, combobox_documentos):
    if tipo_consulta == "documentos":
        documentos = obtener_documentos()
        combobox_documentos['values'] = documentos
